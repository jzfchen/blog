...
Cultivating this ability to acknowledge your efforts in maintaining discipline with an uncritical yet discerning eye allows you to correct disciplinary lapses without unnecessary judgement. This allows one greater clarity when identifying the obstacles and accelerants that can contribute to reaching their goals. The intention is not criticism for failures to be disciplined but acknowledgement. This is only one of many benefits that meditation and journaling are purported to offer, many of which I have only read about and not experienced myself. 
